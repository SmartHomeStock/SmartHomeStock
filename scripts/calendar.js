document.addEventListener('DOMContentLoaded', function () {
    ...
    const initialGridItems = [
        ...
        createGridItem('11/03/2024', 'pages/updates.html#update6', ['date-calendar', 'darken']),
        ...
        createGridItem('22/04/2024', 'pages/updates.html#update10', ['date-calendar', 'darken']),
        createGridItem('29/04/2024', 'pages/updates.html#update11', ['date-calendar', 'darken']),
        createGridItem('06/05/2024', 'pages/updates.html#update12', ['date-calendar', 'darken']),
        createGridItem('13/05/2024', 'pages/updates.html#update13', ['date-calendar', 'darken']),
        createGridItem('20/05/2024', 'pages/updates.html#update14', ['date-calendar', 'darken']),
        createGridItem('27/05/2024', 'pages/updates.html#update15', ['date-calendar', 'darken']),
        createGridItem('03/06/2024', 'pages/updates.html#update16', ['date-calendar', 'darken']),
    ];
